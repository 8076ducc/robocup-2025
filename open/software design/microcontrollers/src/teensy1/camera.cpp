...
void Robot::storeRobotPose()
{
  ...
  robot.current_pose.x = -(blue_goal_real_dist * sin(radians(blue_goal.current_pose.bearing)) + yellow_goal_dist * sin(radians(yellow_goal.current_pose.bearing))) / 2;
  robot.current_pose.y = -(blue_goal_real_dist * cos(radians(blue_goal.current_pose.bearing)) + yellow_goal_dist * cos(radians(yellow_goal.current_pose.bearing))) / 2;
